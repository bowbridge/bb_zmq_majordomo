...
#define CLIENT_PK "CZxDrWQr75SAjw3WNYfan4Vnn-cePBolSIYIyf47N0M"
#define CLIENT_SK "_q-xRN6-BcK-zRvd1HgxG7ytMB0n6jnSBwry3H38-6Q"
...
//        mdp_client_set_verbose(client);
    ...
    mdp_worker_t *worker = mdp_worker_new(endpoint, service, (unsigned char *) CLIENT_PK, (unsigned char *) BROKER_PK);
