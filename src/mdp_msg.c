...
mdp_msg_send(mdp_msg_t *self, zsock_t *output) {
    ...
    switch (self->id) {
        case MDP_MSG_CLIENT_REQUEST: PUT_STRING ("MDPC02");
            PUT_NUMBER1 (1);
        ...
        case MDP_MSG_CLIENT_PARTIAL: PUT_STRING ("MDPC02");
            PUT_NUMBER1 (2);
            PUT_STRING (self->service);
            nbr_frames += self->body ? zmsg_size(self->body) : 1;
            send_body = true;
        ...
        case MDP_MSG_CLIENT_FINAL: PUT_STRING ("MDPC02");
            PUT_NUMBER1 (3);
            PUT_STRING (self->service);
            nbr_frames += self->body ? zmsg_size(self->body) : 1;
            send_body = true;
        ...
        case MDP_MSG_READY: PUT_STRING ("MDPW02");
            PUT_NUMBER1 (1);
            PUT_STRING (self->service);
            break;

        case MDP_MSG_WORKER_REQUEST: PUT_STRING ("MDPW02");
            PUT_NUMBER1 (2);
            nbr_frames++;
            nbr_frames++;
            nbr_frames += self->body ? zmsg_size(self->body) : 1;
        ...
        case MDP_MSG_WORKER_PARTIAL: PUT_STRING ("MDPW02");
            PUT_NUMBER1 (3);
            nbr_frames++;
            nbr_frames++;
            nbr_frames += self->body ? zmsg_size(self->body) : 1;
        ...
        case MDP_MSG_WORKER_FINAL: PUT_STRING ("MDPW02");
            PUT_NUMBER1 (4);
            nbr_frames++;
            nbr_frames++;
            nbr_frames += self->body ? zmsg_size(self->body) : 1;
        ...
        case MDP_MSG_HEARTBEAT: PUT_STRING ("MDPW02");
            PUT_NUMBER1 (5);
            break;

        case MDP_MSG_DISCONNECT: PUT_STRING ("MDPW02");
            PUT_NUMBER1 (6);
            break;
